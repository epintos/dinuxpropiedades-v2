...
public class PublicationTest {
	...
	public void testNullUser() {
		try {
			new Publication(null, "123", 123, 123, 123, "", 123, "123", 123,
					123, null, 123, Operations.SALE, PropertyType.APARTMENT,
					null);
	...
	public void testNullStatus() {
		try {
			Publication p = new Publication(u, "123", 123, 123, 123, "", 123,
					"123", 123, 123, null, 123, Operations.SALE,
	...
	public void testEmptyNeighbourhood() {
		try {
			new Publication(u, "", coversup, uncoversup, roomsQty, description,
					age, street, numbering, floor, apartment, price,
	...
	public void testNullNeighbourhood() {
		try {
			new Publication(u, null, coversup, uncoversup, roomsQty,
					...
					price, operationType, propertyType, services);
		} catch (InformationMissingException e) {
			return;
		}
		Assert.fail();
	...
	public void testLongNeighbourhood() {
		try {
			new Publication(
					...
					numbering, floor, apartment, price, operationType,
	...
	public void testNullDescription() {
		try {
			new Publication(u, neighbourhood, coversup, uncoversup, roomsQty,
					null, age, street, numbering, floor, apartment, price,
					operationType, propertyType, services);
		} catch (BadInformationException e) {
			return;
		}
	...
	public void testMaxAge() {
		...
		try {
			new Publication(u, neighbourhood, coversup, uncoversup, roomsQty,
					...
					apartment, price, operationType, propertyType, services);
		} catch (Exception e) {
			Assert.fail();
		}
		...
		try {
			new Publication(u, neighbourhood, coversup, uncoversup, roomsQty,
					...
					floor, apartment, price, operationType, propertyType,
					services);
		} catch (BadInformationException e) {
			return;
		}
	...
	public void testNullStreet() {
		try {
			new Publication(u, neighbourhood, coversup, uncoversup, roomsQty,
					description, age, null, numbering, floor, apartment, price,
					operationType, propertyType, services);
		} catch (InformationMissingException e) {
			return;
		}
	...
	public void testLongStreetName() {
		...
		try {
			new Publication(u, neighbourhood, coversup, uncoversup, roomsQty,
					description, age, s, numbering, floor, apartment, price,
					operationType, propertyType, services);
		} catch (BadInformationException e) {
			return;
		}
	...
	public void testNegativeNumbering() {
		try {
			new Publication(u, neighbourhood, coversup, uncoversup, roomsQty,
					description, age, street, -1, floor, apartment, price,
					operationType, propertyType, services);
		} catch (BadInformationException e) {
			return;
		}
	...
	public void testNullNumbering() {
		try {
			new Publication(u, neighbourhood, coversup, uncoversup, roomsQty,
					description, age, street, null, floor, apartment, price,
					operationType, propertyType, services);
		} catch (BadInformationException e) {
			return;
		}
	...
	public void testNegativeFloor() {
		try {
			new Publication(u, neighbourhood, coversup, uncoversup, roomsQty,
					description, age, street, numbering, -1, apartment, price,
					operationType, propertyType, services);
		} catch (BadInformationException e) {
			return;
		}
	...
	public void tesBigApartment() {
		...
		try {
			new Publication(u, neighbourhood, coversup, uncoversup, roomsQty,
					description, age, street, numbering, floor, "ABCDE", price,
					operationType, propertyType, services);
		} catch (Exception e) {
			Assert.fail();
		}
	...
	public void testNegativePrice() {
		try {
			new Publication(u, neighbourhood, coversup, uncoversup, roomsQty,
					description, age, street, numbering, floor, apartment, -1,
					operationType, propertyType, services);
		} catch (BadInformationException e) {
			return;
		}
	...
	public void testNullPrice() {
		try {
			new Publication(u, neighbourhood, coversup, uncoversup, roomsQty,
					description, age, street, numbering, floor, apartment,
					null, operationType, propertyType, services);
		} catch (BadInformationException e) {
			return;
		}
		Assert.fail();
	...
	public void testBigPrice() {
		...
		try {
			new Publication(u, neighbourhood, coversup, uncoversup, roomsQty,
					description, age, street, numbering, floor, apartment,
					Integer.MAX_VALUE, operationType, propertyType, services);
		} catch (Exception e) {
			Assert.fail();
		}
		...
		try {
			new Publication(u, neighbourhood, coversup, uncoversup, roomsQty,
					description, age, street, numbering, floor, apartment,
					Integer.MAX_VALUE + 1, operationType, propertyType,
					services);
		} catch (BadInformationException e) {
			return;
		}
	...
	public void testNullOperationType() {
		try {
			new Publication(u, neighbourhood, coversup, uncoversup, roomsQty,
					description, age, street, numbering, floor, apartment,
					price, null, propertyType, services);
		} catch (BadInformationException e) {
			return;
		}
	...
	public void testNullPropertyType() {
		try {
			new Publication(u, neighbourhood, coversup, uncoversup, roomsQty,
					description, age, street, numbering, floor, apartment,
					price, operationType, null, services);
		} catch (BadInformationException e) {
			return;
		}
