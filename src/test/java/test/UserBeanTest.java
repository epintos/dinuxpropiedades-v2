...
public class UserBeanTest {
	...
	public void testIsMyPublication() {
		...
		Publication publication = new Publication(user, neighbourhood, coversup, uncoversup, roomsQty, description, age, street, numbering, floor, apartment, price, operationType, propertyType, services);
		...
		Publication publication2 = new Publication(user, "something", coversup, uncoversup, roomsQty, description, age, street, numbering, floor, apartment, price, operationType, propertyType, services);
