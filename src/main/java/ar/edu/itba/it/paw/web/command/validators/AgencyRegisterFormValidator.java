...
@Component
public class AgencyRegisterFormValidator implements Validator, ValidatorDefines {

	private final static int maxRegisterFieldLenght = 50;
	ValidatorInterface v = new ValidatorImpl();

	public boolean supports(Class<?> clazz) {
		return AgencyRegisterForm.class.equals(clazz);
	}

	public void validate(Object target, Errors errors) {
		AgencyRegisterForm form = (AgencyRegisterForm) target;
	...
	private void validateFields(AgencyRegisterForm form, Errors errors) {
